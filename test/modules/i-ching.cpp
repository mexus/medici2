...
bool TestIChing::TestCalculation() {
    ...
    std::vector<Card> deck3{{{Spades, Seven},
                             {Clubs, Eight},
                             {Clubs, Ace},
                             {Hearts, Six},
                             {Hearts, King},
...
bool TestIChing::TestBalance() {
    std::vector<Card> balancedDeck{{{Hearts, Jack},
                                    {Hearts, Nine},
                                    {Hearts, Ten},
                                    {Diamonds, Queen},
                                    {Clubs, Seven},
                                    ...
                                    {Clubs, Ace},
                                    {Spades, Eight}}};
    std::vector<Card> unbalancedDeck{{{Spades, Jack},
                                      {Hearts, Nine},
                                      {Diamonds, Ace},
                                      {Clubs, Six},
                                      {Clubs, Queen},
                                      ...
                                      {Spades, King},
                                      {Hearts, Jack}}};
    std::vector<Card> balanced2 = {{{Hearts, Jack},
                                    {Clubs, Nine},
                                    {Spades, Ten},
                                    {Hearts, Six},
                                    {Diamonds, Six},
                                    ...
                                    {Hearts, Nine},
                                    {Clubs, Seven}}};
    std::vector<Card> balanced3 = {{{Clubs, Nine},
                                    {Diamonds, Eight},
                                    {Hearts, Ten},
                                    {Spades, Queen},
                                    {Hearts, King},
    ...
    return TestBalance(balancedDeck, true) && TestBalance(unbalancedDeck, false) &&
           TestBalance(balanced2, true) && TestBalance(balanced3, true);
}
...
bool TestIChing::TestBalanceAndSuit() {
    std::vector<Card> balancedDeck{{{Spades, Jack},
                                    {Spades, Nine},
                                    {Clubs, Ten},
                                    {Hearts, Queen},
                                    {Diamonds, Six},
